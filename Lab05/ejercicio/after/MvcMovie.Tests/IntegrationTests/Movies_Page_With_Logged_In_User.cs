...
namespace MvcMovie.Tests.IntegrationTests
{
    ...
    public class Movies_Page_With_Logged_In_User:IClassFixture<CustomWebApplicationFactory<Startup>>
    {
        private readonly CustomWebApplicationFactory<Startup> factory;
        private HttpClient client;
        private const int TERMINATOR_MOVIE_ID = 1;
        private const int GREMLINS_MOVIE_ID = 2;
        public Movies_Page_With_Logged_In_User(CustomWebApplicationFactory<Startup> _factory)
        {
            factory = _factory;
            client = factory
