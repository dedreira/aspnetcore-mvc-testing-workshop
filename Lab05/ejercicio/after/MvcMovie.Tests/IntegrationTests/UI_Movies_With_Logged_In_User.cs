...
namespace MvcMovie.Tests.IntegrationTests
{
    ...
    public class UI_Movies_With_Logged_In_User : IClassFixture<SeleniumServerFactory<Startup>>, IDisposable
    {
        public SeleniumServerFactory<Startup> Server;
        public IWebDriver Browser;
        public HttpClient Client;        

        public UI_Movies_With_Logged_In_User(SeleniumServerFactory<Startup> server)
        {
            Server = server;
            Client = Server
